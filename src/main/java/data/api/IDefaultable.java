...
/**
 * Interface marks class which have default flag. DAO will check if there is only one default object using
 * <code>getExample()</code> method.
 *
...
public interface IDefaultable {
     ...
     * <p>
     * Examplary object should have setted only this properties which are commons in group with one default object, for
     * example parent or category.
     * <p>
